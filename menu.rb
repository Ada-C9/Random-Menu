...
# items_type items. Returns the number.
...
# it contains at least one, non-empty character and is not already an item
# in provided input_items.
...
# Prints prompt about needing provided num amount of provided items_type items.
...
# Prompts user for items of provided items_type type until the user has entered
# provided num_of_items items. Returns the list.
...
# Prompts user for the number of provided items_type items the user wants to
# enter. Until the user enters the user-prescribed number of items, prompts the
# user for items. Returns the items.
...
# provided items_type. Otherwise, prompts user to enter items of items_type
